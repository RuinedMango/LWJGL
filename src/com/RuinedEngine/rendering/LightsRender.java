...
public class LightsRender {
	...
	public LightsRender() {
		...
		shaderModuleDataList.add(new ShaderProgram.ShaderModuleData("resources/shaders/lights.vert", GL20.GL_VERTEX_SHADER));
		shaderModuleDataList.add(new ShaderProgram.ShaderModuleData("resources/shaders/lights.frag", GL20.GL_FRAGMENT_SHADER));
    ...
    public void render(Scene scene, ShadowRender shadowRender, GBuffer gBuffer) {
    	...
    	GL11.glDrawElements(GL11.GL_TRIANGLES, quadMesh.getNumVertices(), GL11.GL_UNSIGNED_INT, 0);
